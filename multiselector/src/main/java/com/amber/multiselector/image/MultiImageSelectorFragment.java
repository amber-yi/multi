...
import com.amber.multiselector.image.adapter.FolderAdapter;
...
public class MultiImageSelectorFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mCategoryText.setText(R.string.multi_image_all);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (mImageAdapter.isShowCamera()) {
                    if (i == 0) {
                        ...
                        ImageInfo image = (ImageInfo) adapterView.getAdapter().getItem(i);
    ...
    private void createPopupFolderList() {
        ...
        mFolderPopupWindow.setBackgroundDrawable(new ColorDrawable(Color.BLACK));
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (index == 0) {
                            ...
                            mCategoryText.setText(R.string.multi_image_all);
                            if(mCallback!=null)
                                mCallback.onFolderChange(getString(R.string.multi_image_all));
                            if (showCamera()) {
...
//        String [] permission=new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.CAMERA};
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            requestPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE,
                    getString(R.string.multi_permission_rationale_write_storage),
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    Toast.makeText(getActivity(), R.string.multi_error_image_not_exist, Toast.LENGTH_SHORT).show();
                }
            } else {
    ...
    private void requestPermission(final String permission, String rationale, final int requestCode){
        if(shouldShowRequestPermissionRationale(permission)){
            new AlertDialog.Builder(getContext())
                    .setTitle(R.string.multi_permission_dialog_title)
                    .setMessage(rationale)
                    .setPositiveButton(R.string.multi_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            requestPermissions(new String[]{permission}, requestCode);
                        }
                    })
                    .setNegativeButton(R.string.multi_permission_dialog_cancel, null)
                    .create().show();
        }else{
            requestPermissions(new String[]{permission}, requestCode);
        }
     ...
     */
    private void selectImageFromGrid(ImageInfo image, int mode) {
        if(image != null) {
            if(mode == MODE_MULTI) {
...
//                        IMAGE_PROJECTION[4]+">0 ", null, IMAGE_PROJECTION[2] + " DESC");
                ...
                if (data.getCount() > 0) {
                    ...
                    do{
                        ...
                        if (!TextUtils.isEmpty(name)) {
                            image = new ImageInfo(path, name, dateTime);
                            images.add(image);
                        }
                        if( !hasFolderGened ) {
                            // get all folder data
                            ...
                            if(folderFile != null && folderFile.exists()){
                                ...
                                ImageFolder f = getFolderByPath(fp);
                                if(f == null){
    ...
    private ImageFolder getFolderByPath(String path){
        if(mResultFolder != null){
            for (ImageFolder folder : mResultFolder) {
