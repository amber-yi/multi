package com.amber.multi.widget.magicindicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void drawIndicator(Canvas canvas) {
        if(mIndicator==0){
            mIndicator=mCircleColor;
        }
        mPaint.setColor(mIndicator);
    ...
    public void setIndicator(int mIndicator) {
